...
The index context is present on both the root URL of the blog (`/`) and on subsequent pages of the post list, which live at `/page/:num/`. All routes are now customisable with [Dynamic Routing](https://docs.ghost.org/v2/docs/dynamic-routing).
