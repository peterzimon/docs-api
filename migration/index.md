...
{
  "type": "warning",
  "title": "Importing large exports into your production blog",
  "body": "If you have a large database export (> 10mb), you have to ensure that your server has enough memory. We recommend 2GB. If you are still getting an error on import, it could be that the browser has timed out. Wait a little longer and data should be imported fine afterwards. You can also watch your server logs in the meanwhile with `ghost log -f`."
}
[/block]
...
* Blogger users can try the recently released [Blogger2Ghost.NET](https://github.com/jessehouwing/Blogger2Ghost) or the much older [Blogger2Ghost](https://github.com/bebraw/blogger2ghost).
...
* [Medium to Ghost](https://github.com/ageitgey/medium_to_ghost)
